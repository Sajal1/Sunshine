...
public class MainActivity extends ActionBarActivity implements ForecastFragment.Callback {
    ...
    //String SENDER_ID = "75509282167";
    public static final String PROJECT_NUMBER = "142754841987";
...
//            if (PROJECT_NUMBER.equals("75509282167")) {
...
//                getString(R.string.pref_location_default));
    ...
    protected void onResume() {
        super.onResume();  if (!checkPlayServices()) {
            // Store regID as null
            storeRegistrationId(this, null);
        }
...
//this is the function that will run while the main activity resumes after being paused when switched to another activity and returns
